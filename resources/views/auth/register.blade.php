    ...
    <div class="w-full min-h-screen flex flex-col md:flex-row">
        ...
        <div class="flex-1 flex flex-col justify-center items-center px-6 py-12">
            <div class="w-full max-w-md">
                <h2 class="text-3xl font-bold mb-8 text-gray-900">Get Started Now</h2>
                <form class="space-y-5" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-gray-700">I agree to the <a href="#"
                                class="underline">terms & policy</a></label>
                    </div>
                    <button type="submit"
                        class="w-full bg-green-800 text-white py-2 rounded-md font-semibold hover:bg-green-900 transition">Signup</button>
                </form>
                ...
                <div class="flex flex-col sm:flex-row gap-3 mb-6">
                    <button disabled
                        ...
                        <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google"
                            class="w-5 h-5 mr-2"> Sign up with Google
                    </button>
                    <button disabled
                        class="flex-1 flex items-center justify-center border border-gray-300 rounded-md py-2 bg-gray-100 text-gray-400 cursor-not-allowed">
                ...
                <div class="text-center text-sm text-gray-700">
                    Have an account? <a href="{{ route('login') }}"
                        class="text-blue-700 font-semibold hover:underline">Sign In</a>
                </div>
            </div>
        </div>
        <!-- Right: Image -->
